...
export async function POST(req: Request) {
  try {
    ...
    const apiUrl = `https://us-central1-aiplatform.googleapis.com/v1/projects/${projectId}/locations/us-central1/reasoningEngines/2559478351509061632:streamQuery?alt=sse`;
